...
cp /tmp/hyperledger/org3/ca/admin/msp/cacerts/0-0-0-0-7055.pem /tmp/hyperledger/org3/peer2/assets/ca/org3-ca-cert.pem

mkdir -p /tmp/hyperledger/org3/peer2/assets/tls-ca 
cp /tmp/hyperledger/tls-ca/admin/msp/cacerts/0-0-0-0-7052.pem /tmp/hyperledger/org3/peer2/assets/tls-ca/tls-ca-cert.pem
...
cp /tmp/hyperledger/org3/peer2/tls-msp/keystore/*_sk /tmp/hyperledger/org3/peer2/tls-msp/keystore/key.pem
...
mkdir -p /tmp/hyperledger/org3/peer2/msp/admincerts
